...
- `prototype-functional-onepage.html` — 중앙 집중형 정보 영역과 제한된 타이포그래피·간격 규칙을 사용하는 단일 페이지 프로토타입. `Selected Photography`에는 mixed-ratio justified layout을 통합했고, DODREI 실제 웹 작품의 live iframe embed와 YouTube 영상의 최소 UI embed 방식도 함께 시험한다.
